...
public class Utility {
    public static func randomCard() -> Card {
    ...
    public static func randomCard(rank: Int) -> Card {
        let suit = Suit.random()
        return Card(rank: rank, suit: suit)
    }
    
    public static func randomCard(excludingRank: Int) -> Card {
    ...
    public static func shouldSplitCards(playerCard1: Card, playerCard2: Card, dealerCard: Card) -> (Bool, String) {
